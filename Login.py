...
class LoginPage(tk.Frame):
    def __init__(self, root,switch_to_Signup,switch_to_HomePage):
        ...
        self.heading = tk.Label(self.frame, text="Login", fg="#57A1F8", bg="white", font=("Microsoft YaHei UI Light", 23, "bold"))
        ...
        tk.Frame(self.frame, width=295, height=2, bg="black").place(x=25, y=172)

        tk.Button(self.frame, width=39, pady=7, text="Sign in", bg='#57A1F8', fg="white", border=0,command=self.loginlogic).place(x=35, y=204)

        self.label = tk.Label(self.frame, text="Don't have an account?", fg="black", bg="white", font=("Microsoft YaHei UI Light", 9))
        self.label.place(x=75, y=270)

        self.sign_up = tk.Button(self.frame, width=6, text="Sign up", border=0, bg="white", cursor='hand2', fg="#57A1F8", command=switch_to_Signup)
